...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingServiceDetail.link'
        db.alter_column('canada_post_dp_shipping_shippingservicedetail', 'link', self.gf('jsonfield.fields.JSONField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ShippingServiceDetail.link'
        raise RuntimeError("Cannot reverse this migration. 'ShippingServiceDetail.link' and its values cannot be restored.")
    ...
    models = {
        ...
        'canada_post_dp_shipping.shippingservicedetail': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('jsonfield.fields.JSONField', [], {'max_length': '256', 'null': 'True'}),
