...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShipmentLink.shipping_detail'
        db.delete_column('canada_post_dp_shipping_shipmentlink', 'shipping_detail_id')

        # Adding field 'ShipmentLink.parcel_description'
        db.add_column('canada_post_dp_shipping_shipmentlink', 'parcel_description', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['canada_post_dp_shipping.ParcelDescription']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ShipmentLink.shipping_detail'
        raise RuntimeError("Cannot reverse this migration. 'ShipmentLink.shipping_detail' and its values cannot be restored.")
    ...
    models = {
        ...
        'canada_post_dp_shipping.shipmentlink': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parcel_description': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canada_post_dp_shipping.ParcelDescription']"}),
