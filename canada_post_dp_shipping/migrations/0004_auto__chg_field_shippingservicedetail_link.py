...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('canada_post_dp_shipping_shippingservicedetail', 'link', self.gf('jsonfield.fields.JSONField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'ShippingServiceDetail.link'
        db.alter_column('canada_post_dp_shipping_shippingservicedetail', 'link', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'canada_post_dp_shipping.shippingservicedetail': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('jsonfield.fields.JSONField', [], {'max_length': '256'}),
