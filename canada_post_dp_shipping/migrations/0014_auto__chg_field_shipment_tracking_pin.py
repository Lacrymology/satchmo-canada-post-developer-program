...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('canada_post_dp_shipping_shipment', 'tracking_pin', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    models = {
        ...
        'canada_post_dp_shipping.shipment': {
            ...
            'label': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
