...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shipment.tracking_pin'
        db.alter_column('canada_post_dp_shipping_shipment', 'tracking_pin', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Shipment.return_tracking_pin'
        db.alter_column('canada_post_dp_shipping_shipment', 'return_tracking_pin', self.gf('django.db.models.fields.BigIntegerField')(max_length=16, null=True))


    def backwards(self, orm):
        
        # Changing field 'Shipment.tracking_pin'
        db.alter_column('canada_post_dp_shipping_shipment', 'tracking_pin', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Shipment.return_tracking_pin'
        db.alter_column('canada_post_dp_shipping_shipment', 'return_tracking_pin', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    models = {
        ...
        'canada_post_dp_shipping.shipment': {
            ...
            'return_tracking_pin': ('django.db.models.fields.BigIntegerField', [], {'default': 'None', 'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '14'}),
            'tracking_pin': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '16', 'null': 'True', 'blank': 'True'})
        },
