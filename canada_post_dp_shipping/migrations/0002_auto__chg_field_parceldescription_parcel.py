...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParcelDescription.parcel'
        db.alter_column('canada_post_dp_shipping_parceldescription', 'parcel', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'ParcelDescription.parcel'
        db.alter_column('canada_post_dp_shipping_parceldescription', 'parcel', self.gf('django.db.models.fields.CharField')(max_length=256))
