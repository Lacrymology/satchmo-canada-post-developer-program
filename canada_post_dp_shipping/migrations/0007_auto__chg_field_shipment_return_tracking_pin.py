...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('canada_post_dp_shipping_shipment', 'return_tracking_pin', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
    ...
    models = {
        ...
        'canada_post_dp_shipping.shipment': {
            ...
            'return_tracking_pin': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '16', 'null': 'True', 'blank': 'True'}),
