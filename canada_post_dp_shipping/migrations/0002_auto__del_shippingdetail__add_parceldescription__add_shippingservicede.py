...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Box', fields ['width', 'length', 'max_weight', 'height']
        db.delete_unique('canada_post_dp_shipping_box', ['width', 'length', 'max_weight', 'height'])
        ...
        db.create_table('canada_post_dp_shipping_parceldescription', (
            ...
            ('shipping_detail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canada_post_dp_shipping.ShippingServiceDetail'])),
        ...
        # Adding model 'ShippingServiceDetail'
        db.create_table('canada_post_dp_shipping_shippingservicedetail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('canada_post_dp_shipping', ['ShippingServiceDetail'])

        # Deleting field 'Box.max_weight'
        db.delete_column('canada_post_dp_shipping_box', 'max_weight')

        # Adding unique constraint on 'Box', fields ['width', 'length', 'height']
        db.create_unique('canada_post_dp_shipping_box', ['width', 'length', 'height'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Box', fields ['width', 'length', 'height']
        db.delete_unique('canada_post_dp_shipping_box', ['width', 'length', 'height'])
        ...
        # Deleting model 'ShippingServiceDetail'
        db.delete_table('canada_post_dp_shipping_shippingservicedetail')

        # User chose to not deal with backwards NULL issues for 'Box.max_weight'
        raise RuntimeError("Cannot reverse this migration. 'Box.max_weight' and its values cannot be restored.")

        # Adding unique constraint on 'Box', fields ['width', 'length', 'max_weight', 'height']
        db.create_unique('canada_post_dp_shipping_box', ['width', 'length', 'max_weight', 'height'])
