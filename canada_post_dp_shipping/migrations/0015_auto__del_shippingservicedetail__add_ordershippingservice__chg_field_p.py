...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParcelDescription.shipping_detail'
        db.alter_column('canada_post_dp_shipping_parceldescription', 'shipping_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canada_post_dp_shipping.OrderShippingService']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ParcelDescription.shipping_detail'
        db.alter_column('canada_post_dp_shipping_parceldescription', 'shipping_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canada_post_dp_shipping.ShippingServiceDetail']))
