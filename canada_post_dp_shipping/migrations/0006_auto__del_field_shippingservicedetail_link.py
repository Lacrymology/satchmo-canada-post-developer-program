...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShippingServiceDetail.link'
        db.delete_column('canada_post_dp_shipping_shippingservicedetail', 'link')


    def backwards(self, orm):
        
        # Adding field 'ShippingServiceDetail.link'
        db.add_column('canada_post_dp_shipping_shippingservicedetail', 'link', self.gf('jsonfield.fields.JSONField')(max_length=256, null=True), keep_default=False)
