...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Shipment.tracking_pin'
        db.alter_column('canada_post_dp_shipping_shipment', 'tracking_pin', self.gf('django.db.models.fields.IntegerField')(max_length=16, null=True))

        # Changing field 'Shipment.return_tracking_pin'
        db.alter_column('canada_post_dp_shipping_shipment', 'return_tracking_pin', self.gf('django.db.models.fields.IntegerField')(max_length=16, null=True))
