...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderShippingService.transmitted'
        db.add_column('canada_post_dp_shipping_ordershippingservice', 'transmitted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderShippingService.transmitted'
        db.delete_column('canada_post_dp_shipping_ordershippingservice', 'transmitted')
