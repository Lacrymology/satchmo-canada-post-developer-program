...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canada_post_dp_shipping_manifest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('po_number', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('artifact', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('canada_post_dp_shipping', ['Manifest'])

        # Adding model 'ManifestLink'
        db.create_table('canada_post_dp_shipping_manifestlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('manifest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canada_post_dp_shipping.Manifest'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('data', self.gf('jsonfield.fields.JSONField')(blank=True)),
        ))
        db.send_create_signal('canada_post_dp_shipping', ['ManifestLink'])

        # Adding field 'OrderShippingService.manifest'
        db.add_column('canada_post_dp_shipping_ordershippingservice', 'manifest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canada_post_dp_shipping.Manifest'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Manifest'
        db.delete_table('canada_post_dp_shipping_manifest')

        # Deleting model 'ManifestLink'
        db.delete_table('canada_post_dp_shipping_manifestlink')

        # Deleting field 'OrderShippingService.manifest'
        db.delete_column('canada_post_dp_shipping_ordershippingservice', 'manifest_id')
    ...
    models = {
        ...
        'canada_post_dp_shipping.box': {
            'Meta': {'ordering': "['description', '-length', '-width', '-height']", 'unique_together': "(('length', 'width', 'height'),)", 'object_name': 'Box'},
        ...
        'canada_post_dp_shipping.manifest': {
            'Meta': {'object_name': 'Manifest'},
            'artifact': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'po_number': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        'canada_post_dp_shipping.manifestlink': {
            'Meta': {'object_name': 'ManifestLink'},
            'data': ('jsonfield.fields.JSONField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manifest': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canada_post_dp_shipping.Manifest']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '16'})
        },
        'canada_post_dp_shipping.ordershippingservice': {
            'Meta': {'ordering': "['-order']", 'object_name': 'OrderShippingService'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manifest': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canada_post_dp_shipping.Manifest']", 'null': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
            'transmitted': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'canada_post_dp_shipping.parceldescription': {
            'Meta': {'ordering': "['-shipping_detail__order', 'id']", 'object_name': 'ParcelDescription'},
            'box': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canada_post_dp_shipping.Box']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parcel': ('django.db.models.fields.TextField', [], {}),
