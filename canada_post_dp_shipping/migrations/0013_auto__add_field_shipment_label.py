...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Shipment.label'
        db.add_column('canada_post_dp_shipping_shipment', 'label', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Shipment.label'
        db.delete_column('canada_post_dp_shipping_shipment', 'label')
