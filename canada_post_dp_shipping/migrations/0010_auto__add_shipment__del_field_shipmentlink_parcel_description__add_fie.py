...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canada_post_dp_shipping_shipment', (
            ...
            ('tracking_pin', self.gf('django.db.models.fields.IntegerField')(max_length=16, null=True)),
            ('return_tracking_pin', self.gf('django.db.models.fields.IntegerField')(max_length=16, null=True)),
        ...
        # Deleting field 'ShipmentLink.parcel_description'
        db.delete_column('canada_post_dp_shipping_shipmentlink', 'parcel_description_id')

        # Adding field 'ShipmentLink.shipment'
        db.add_column('canada_post_dp_shipping_shipmentlink', 'shipment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['canada_post_dp_shipping.ParcelDescription']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ShipmentLink.parcel_description'
        raise RuntimeError("Cannot reverse this migration. 'ShipmentLink.parcel_description' and its values cannot be restored.")

        # Deleting field 'ShipmentLink.shipment'
        db.delete_column('canada_post_dp_shipping_shipmentlink', 'shipment_id')
    ...
    models = {
        ...
        'canada_post_dp_shipping.shipment': {
            ...
            'return_tracking_pin': ('django.db.models.fields.IntegerField', [], {'max_length': '16', 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '14'}),
            'tracking_pin': ('django.db.models.fields.IntegerField', [], {'max_length': '16', 'null': 'True'})
        },
        'canada_post_dp_shipping.shipmentlink': {
            'Meta': {'object_name': 'ShipmentLink'},
            'data': ('jsonfield.fields.JSONField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canada_post_dp_shipping.ParcelDescription']"}),
