...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParcelDescription.weight'
        db.add_column('canada_post_dp_shipping_parceldescription', 'weight', self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=5, decimal_places=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParcelDescription.weight'
        db.delete_column('canada_post_dp_shipping_parceldescription', 'weight')
    ...
    models = {
        ...
        'canada_post_dp_shipping.shipmentlink': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shipping_detail': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canada_post_dp_shipping.ParcelDescription']"}),
