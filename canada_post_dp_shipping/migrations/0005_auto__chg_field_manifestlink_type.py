...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ManifestLink.type'
        db.alter_column('canada_post_dp_shipping_manifestlink', 'type', self.gf('django.db.models.fields.CharField')(max_length=64))


    def backwards(self, orm):
        
        # Changing field 'ManifestLink.type'
        db.alter_column('canada_post_dp_shipping_manifestlink', 'type', self.gf('django.db.models.fields.CharField')(max_length=16))
